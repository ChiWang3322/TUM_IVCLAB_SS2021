...
for i = 1:length(scales_video)
    ...
    for j = 1:num_frames
        ...
        % Motion compensation
            ...
            if j == 2
                pmf_mv = stats_marg(motion_vector, 1:81);
...
ylabel('PSNR [dB]');
%% Train Huffmann Table
[BinaryTree, HuffCode, BinCode, Codelengths] = TrainHuffTable();
save HuffmannTable.mat BinaryTree HuffCode BinCode Codelengths; 
