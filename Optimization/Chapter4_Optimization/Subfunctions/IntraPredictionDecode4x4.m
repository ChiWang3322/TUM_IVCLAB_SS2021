function [Image] = IntraPredictionDecode4x4(ResImage, BorderArray, modeArray4x4)
...
% 
    [M, N, C] = size(ResImage);
    block_size = 8;
    ori_image = double(imread('foreman0024.bmp'));
	ori_image = ictRGB2YCbCr(ori_image);
    ...
    for c = 1:C
        for i = 1:block_size:M
            for j = 1:block_size:N
                ...
                mode = modeArray4x4(floor(i / block_size) + 1, floor(j / block_size) + 1, c);
                if mode == 0
