...
load video_codec_values_optimized_SSD.mat
plot(BPP_mean_video, PSNR_mean_video, '--o', 'LineWidth' , 2, 'MarkerSize', 8);


load video_codec_values_SSD_frac.mat
plot(BPP_mean_video, PSNR_mean_video, '--o', 'LineWidth' , 2, 'MarkerSize', 8);

load video_codec_values_SSD_mul_optim_huff.mat
plot(BPP_mean_video, PSNR_mean_video, '--o', 'LineWidth' , 2, 'MarkerSize', 8);

legend('Non-optimized Video codec', 'Optimized(logsearch)', 'Optimized(logsearch+frac)', 'Optimized(Multiple reference)', 'Location', 'southeast');
