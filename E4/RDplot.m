...
R = 7.09;
PSNR = 38.53;
plot(R, PSNR, 'Marker', '+', 'Color', [0.8500 0.3250 0.0980]);
text(R + offset(1), PSNR(1), 'lena\_predictive\_encoding');
%Vector quantization
R = 5.67;
PSNR = 34.62;
plot(R, PSNR, 'Marker', '*', 'Color', [0.4940 0.1840 0.5560]);
text(R + offset(1), PSNR(1), 'lena\_vector\_quantization');
%Add title and label
title('R-D plot');
xlim([0, 25]);;
